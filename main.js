...
const rod2Material = new THREE.LineBasicMaterial({ color: 0xffffff });
const rod2Geometry = new THREE.BufferGeometry().setFromPoints([
    new THREE.Vector3(0, 0, 0),
    new THREE.Vector3(0, 0, 0)
]);
const rod2 = new THREE.Line(rod2Geometry, rod2Material);
scene.add(rod2);
