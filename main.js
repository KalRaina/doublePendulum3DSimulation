...
document.getElementById("theta1").addEventListener("input", () => {
    anglesChanged = true;
    document.getElementById("angleNote").style.display = "block";
});

document.getElementById("phi1").addEventListener("input", () => {
    anglesChanged = true;
    document.getElementById("angleNote").style.display = "block";
});

document.getElementById("theta2").addEventListener("input", () => {
    anglesChanged = true;
    document.getElementById("angleNote").style.display = "block";
});

document.getElementById("phi2").addEventListener("input", () => {
    anglesChanged = true;
    document.getElementById("angleNote").style.display = "block";
});
...
function startMotion() {
    ...
    document.getElementById("angleNote").style.display = "none";
...
function animate(){
    ...
    if (audioMuted){
        ...
        gainNode.gain.value = 0.3 + 0.15 * smoothAudio; 
    };

    let cutoff = 120 + 30 * smoothAudio;   // softer filter movement
    filter.frequency.value = cutoff; 

    osc.frequency.value = 80 + 1.0 * smoothAudio; 
    osc2.frequency.value = 82 + 1.0 * smoothAudio;
